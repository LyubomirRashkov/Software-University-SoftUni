namespace Problem01.FasterQueue.Tests
{
    using System;
    using System.Linq;
    ...
    public class QueueTests
    {
        ...
        [Test]
        public void DequeueShouldRemoveTheFirstElement()
        {
            var queue = GetQueue();
            var count = this._random.Next(10, 30);
            var array = new int[count];
        ...
        [Test]
        public void DequeueShouldThrowExceptionIfTheQueueContainsNoElements()
        {
            var queue = GetQueue();
