        ...
        static void Main(string[] args)
        {
            ...
            while (!textSR.EndOfStream)
            {
                ...
                foreach (var kvp in appearancesByWord)
                {
                    ...
                    MatchCollection matches = regex.Matches(lineOfWords.ToLowerInvariant());

                    appearancesByWord[kvp.Key] += matches.Count;
                }
            }
            ...
            using StreamWriter sw = new StreamWriter(@"..\..\..\..\Results-Outputs\03-2.WordCountOutput.txt");
