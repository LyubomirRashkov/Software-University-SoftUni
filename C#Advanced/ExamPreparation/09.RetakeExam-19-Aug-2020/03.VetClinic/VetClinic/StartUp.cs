...
namespace VetClinic
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            // Print Pet
            Console.WriteLine(dog); // Name: Ellias Age: 5 Owner: Tim
            ...
            Console.WriteLine(oldestPet); // Name: Zak Age: 4 Owner: Jon

            // Get Pet
            Pet pet = clinic.GetPet("Bella", "Mia");
            Console.WriteLine(pet); // Name: Bella Age: 2 Owner: Mia
            ...
            //Pet Bella with owner: Mia
            //Pet Zak with owner: Jon
